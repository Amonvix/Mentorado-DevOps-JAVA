...
public class lotofacil {
    ...
    public static void main(String[] args) { 
        ...
        int []  j09 = {02,05,06,07,9,10,12,13,14,16,18,20,21,22,24};        
        int []  j10 = {01,02,06,07,8,9,11,13,14,16,17,18,21,22,23};        
        int []  j11 = {01,02,03,05,9,10,12,13,15,16,17,19,23,24,25};        
        int []  j12 = {02,03,04,07,10,11,12,15,16,17,20,21,22,23,25};
